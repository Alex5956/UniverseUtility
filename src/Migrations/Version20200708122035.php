 ...
 */
final class Version20200708122035 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, id_key VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE user ADD telephone VARCHAR(255) NOT NULL, ADD name VARCHAR(255) NOT NULL, ADD file VARCHAR(255) NOT NULL, DROP age, DROP uuid, DROP last_name, CHANGE email email VARCHAR(180) NOT NULL, CHANGE roles roles JSON NOT NULL, CHANGE firstname firstname VARCHAR(255) NOT NULL');
    }
